...
const ENTITY_PROPERTIES = {
	...
	"Material": [
		"albedo_color", "roughness", "metallic", "metallic_specular", "texture_id", "emission_enabled", "emission", "emission_energy_multiplier", "uv1_scale", "uv1_triplanar", "uv1_world_triplanar"
	],
	"hidden": [
		"id",
	]
